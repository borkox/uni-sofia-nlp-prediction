...
@Slf4j
public class TrainWithScoring1 {
    ...
    public static void main(String[] args) throws IOException {
        String pathname = TrainWithScoring1.class.getResource("/raw_sentences.txt").getFile();
        ...
        */
        ...
        LearnNgramMDP learnNgramMDP = new LearnNgramMDP(new SearchVocabCache(lookupTable, new WordScore1()),
                sequenceIterator);
        ...
        pol.save("persist/val1", "persist/pol1");
